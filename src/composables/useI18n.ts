...
export function useI18n() {
  ...
  const messages = {
    ...
    supply_item_modal: {
      ...
      shopping_hint_help: (): string => m["supply_item_modal.shopping_hint_help"](),
      ...
      preferred_brands_help: (): string => m["supply_item_modal.preferred_brands_help"](),
      quantity_help: (): string => m["supply_item_modal.quantity_help"](),
      close_tooltip: (): string => m["supply_item_modal.close_tooltip"](),
